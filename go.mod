...
require (
	...
	github.com/iden3/go-schema-processor/v2 v2.0.0-20230620145315-a90bb5e97440
...
require (
	...
	github.com/iden3/go-iden3-core/v2 v2.0.0-20230519124718-42b31ff46f37 // indirect
